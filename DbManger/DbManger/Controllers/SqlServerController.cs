...
namespace DdManger.Web.Controllers
{
    ...
    public class SqlServerController : Controller
    {
        ...
        {
            ConnectionString = ConfigHelper.Get("sqlserverConnectionString"),          
...
order by a.id,a.colorder";
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult LockTables()
        {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult EditTableDescription(string table)
        {     
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult EditTableCDescription(string table, string column)
        {
